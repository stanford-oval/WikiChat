...
from tasks.defaults import DEFAULT_VECTORDB_COLLECTION_NAME, DEFAULT_VECTORDB_PORT
...
def main():
    ...
    parser.add_argument(
        "--collection_name",
        type=str,
        default=DEFAULT_VECTORDB_COLLECTION_NAME,
        required=False,
    ...
    if args.action == "save":
        ...
        requests.post(
            f"http://localhost:{DEFAULT_VECTORDB_PORT}/collections/{args.collection_name}/snapshots/upload",
